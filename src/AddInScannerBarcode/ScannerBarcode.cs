...
namespace AddIn
{
    [ProgId("AddIn.ScannerBarcode")]
    [ClassInterface(ClassInterfaceType.None)]
    public class ScannerBarcode : IScannerBarcode, IInitDone, ILanguageExtender
    {
        ...
        private void _serialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                {
                    asyncEvent.ExternalEvent("ScannerBarcode", "ScanData", data);
                }));
        ...
        public const string AddInName = "ScannerBarcode";
